...
class DbTransport ():
    ...
    def set_ap_on_db(self, data):
        requests.post('http://' + self.server_ip + '/report', data=data, headers={"content-type":"application/json"})
...
class MockerTestsDbTransport(MockerTestCase):
    ...
    def test_get_db_data_ok (self):
        ...
        result.json
        self.mocker.result(json.dumps(self.report))
        result.headers
        ...
        self.assertEqual(v, json.dumps(self.report))
        self.mocker.verify()
